...
public class MyAsyncTask extends AsyncTask<Void, Integer, String> {
	 ...
	 */
	private OrphanAsyncTaskThreadTutoActivity activity;
	/**
	 * 
	 */
	private String name;
	 ...
	 * @param activity
	 */
	public MyAsyncTask(OrphanAsyncTaskThreadTutoActivity activity,String name) {
		super();
	...
	protected String doInBackground(Void... unused) {
		try {
			// To understand the orphan thread you have 200 seconds
			while (count < 200) {
